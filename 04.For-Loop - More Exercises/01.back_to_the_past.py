...
for i in range(1800, year + 1):
    ...
    if i % 2 == 0:
        ...
        living_money += (12000 + (50 * ivancho_age) - 50)

if living_money <= inheritance:
    print(f"Yes! He will live a carefree life and will have {abs(inheritance - living_money):.2f} dollars left." )

elif living_money > inheritance:
    print(f"He will need {abs(living_money - inheritance):.2f} dollars to survive.")
