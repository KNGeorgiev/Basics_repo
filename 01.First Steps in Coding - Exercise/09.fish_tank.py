...
width = int(input())
height = int(input())
percentage_volume_taken = float(input())

total_volume_ltr = (lenght * width * height) / 1000
total_volume_taken = total_volume_ltr - total_volume_ltr * percentage_volume_taken / 100

print(total_volume_taken)
